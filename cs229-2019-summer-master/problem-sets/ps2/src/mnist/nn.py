...
def forward_prop(data, labels, params):
    ...
    cost = np.sum(-labels*np.log(a2)) / data.shape[0]
...
def gradient_descent_epoch(train_data, train_labels, learning_rate, batch_size, params, forward_prop_func, backward_prop_func):
    ...
    for i in range(nexp // batch_size):
        grad = backward_prop_func(
            train_data[i*1000:i*1000+1000,:], 
            train_labels[i*1000:i*1000+1000,:], 
...
def main():
    ...
    np.random.seed(100)
    train_data, train_labels = read_data('./ps2/src/mnist/images_train.csv', './ps2/src/mnist/labels_train.csv')
    ...
    test_data, test_labels = read_data('./ps2/src/mnist/images_test.csv', './ps2/src/mnist/labels_test.csv')
