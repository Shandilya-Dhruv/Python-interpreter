...
def main():
    train_messages, train_labels = util.load_spam_dataset('ps2-sol/src/spam/spam_train.tsv')
    val_messages, val_labels = util.load_spam_dataset('ps2-sol/src/spam/spam_val.tsv')
    test_messages, test_labels = util.load_spam_dataset('ps2-sol/src/spam/spam_test.tsv')
