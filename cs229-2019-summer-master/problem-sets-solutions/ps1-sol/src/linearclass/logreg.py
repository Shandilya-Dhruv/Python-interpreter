...
if __name__ == '__main__':
    main(train_path='src/linearclass/ds1_train.csv',
         valid_path='src/linearclass/ds1_valid.csv',
         save_path='src/linearclass/.txt')

    main(train_path='src/linearclass/ds2_train.csv',
         valid_path='src/linearclass/ds2_valid.csv',
         save_path='src/linearclass/logreg_pred_2.txt')
